...
<div class="glide">
  <div class="glide__track" data-glide-el="track">
    ...
    <?php foreach($slides as $slide) : ?>
        <li class="glide__slide bg-primary bg-cover bg-no-repeat h-full flex flex-col items-center justify-center" style="background-image:url(<?php echo get_template_directory_uri(); ?>/img/<?= $slide['img'] ?>")">
		  <h4 class="text-2xl text-gray-900"><?= $slide['subtitle'] ?></h4>
		  <h3 class="text-6xl font-bold text-primary2"><?= $slide['title'] ?></h3>
      </li>
      <?php endforeach ?>
	</ul>
  </div>
