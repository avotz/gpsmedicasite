...
function hideModal() {
  dynamics_js__WEBPACK_IMPORTED_MODULE_0___default().animate(modal, {
    opacity: 0,
    translateY: 100
  }, {
...
function showModal() {
  ...
  dynamics_js__WEBPACK_IMPORTED_MODULE_0___default().css(modal, {
    opacity: 0,
    scale: .5
  });
...
function showModalChildren() {
  ...
  for (var i = 0; i < modalChildren.length; i++) {
    ...
    // Define initial properties
    dynamics_js__WEBPACK_IMPORTED_MODULE_0___default().css(item, {
      opacity: 0,
      translateY: 30
    });

    // Animate to final properties
    dynamics_js__WEBPACK_IMPORTED_MODULE_0___default().animate(item, {
      opacity: 1,
      translateY: 0
    }, {
      type: (dynamics_js__WEBPACK_IMPORTED_MODULE_0___default().spring),
...
function closeModal() {
  hideModal();
  dynamics_js__WEBPACK_IMPORTED_MODULE_0___default().setTimeout(toggleClasses, 500);
...
/******/ 	var __webpack_exports__ = __webpack_require__.O(undefined, ["style"], () => (__webpack_require__("./resources/css/app.css")))
